...
class TestRagSearch(unittest.TestCase):
    ...
    @patch("chromadb.PersistentClient")
    def test_list_collections_exception(self, mock_client):
    ...
    @patch("chromadb.PersistentClient")
    def test_execute_rag_query_success(self, mock_client, mock_agent, mock_vertex, mock_run_query):
    ...
    @patch("research_agent.ui.streamlit.rag_search.run_rag_query")
    @patch("chromadb.PersistentClient")
    def test_execute_rag_query_exception(self, mock_client, mock_run_query):
    ...
    def test_render_rag_search_ui_basic(self, mock_list_collections):
...
"""
    ...
    def test_render_rag_search_ui_with_query(self, mock_asyncio_run, mock_list_collections):
