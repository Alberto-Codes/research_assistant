...
from research_agent.core.rag.nodes import QueryNode, RetrieveNode, AnswerNode
...
async def test_run_rag_query(mock_chroma_collection, mock_gemini_model):
    ...
    with patch.object(rag_graph, "run", return_value=MagicMock(text="Generated answer.\n\nSources: doc1.md, doc2.md")) as mock_run, \
